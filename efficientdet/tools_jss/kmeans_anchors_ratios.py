...
# python3 kmeans_anchors_ratios.py --anchors-sizes 32 64 128 256 512 --input-size 512 --normalizes-bboxes True --num-runs 3 --num-anchors-ratios 3 --max-iter 300 --min-size 0 --iou-threshold 0.5 --decimals 1 --default-anchors-ratios '[(0.7, 1.4), (1.0, 1.0), (1.4, 0.7)]'
def _parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        metavar="N",
        default='/data/wurenji/code_new/Yet-Another-EfficientDet-Pytorch/datasets/jueyuanzi_zangwu_2class/annotations/instances_train_2class.json',
        # default = '/data/wurenji/code_new/Yet-Another-EfficientDet-Pytorch/datasets/coco/annotations/instances_valminusminival2014.json',
